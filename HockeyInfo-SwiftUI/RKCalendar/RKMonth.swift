            ...
            switch self.rkManager.mode
            {
                case 0:
                    ...
                    else
                    {
                        ...
                        self.rkManager.scheduledGameModelList = DBManager().retrieveScheduledGamesForDate(date.getTextFromDate())
                        
                        print("Size of game list is: \(self.rkManager.scheduledGameModelList.count)")
                    }
